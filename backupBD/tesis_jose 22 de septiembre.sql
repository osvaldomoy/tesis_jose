...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-09-2018 a las 22:03:18
...
(1, 'ACEITE TIPO 1', 41, 5, 2500),
(2, 'ACEITE TIPO 2', 100, 10, 3600),
(3, 'LUBRICANTE TIPO A', 35, 10, 7800),
...
--
ALTER TABLE `clientes_atendidos`
  MODIFY `codigo_clientes_atendidos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `clientes_en_espera`
  MODIFY `codigo_cliente_en_espera` int(11) NOT NULL AUTO_INCREMENT;
