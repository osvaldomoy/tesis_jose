        ...
        <div class="modal-content">
            ...
            <div id="cuerpo-modal" class="modal-body">
                <form>
                    ...
                    <div class="form-group row">
                        <div class="col-sm">
                            <label for="colFormLabelSm" class="col-sm col-form-label col-form-label-sm">Cédula</label>
                            <input type="number" id="cedula_cliente" class="form-control form-control-sm" placeholder="&#xf2bb; Cédula">
                          <!--<small id="emailHelp" class="form-text text-muted">Campo requerido.</small>-->
                        </div>
                        <div class="col-sm">
                            <label for="colFormLabelSm" class="col-sm col-form-label col-form-label-sm">Teléfono</label>
                    ...
                    <div class="form-group row">
                        <div class="col-sm">
                            <label for="colFormLabelSm" class="col-sm col-form-label col-form-label-sm">Correo electrónico</label>
