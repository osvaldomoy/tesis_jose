    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="ResetModalAutomovil();">
            ...
            <div id="cuerpo-modal" class="modal-body">
                <form>
                    <div class="form-group row">
                        ...
                        <div class="col-sm">
                            <label for="colFormLabelSm" class="col-sm col-form-label col-form-label-sm">Modelo</label>
                    ...
                    <div class="form-group row">
                        <div class="col-sm">
                            <label for="colFormLabelSm" class="col-sm col-form-label col-form-label-sm">Año</label>
